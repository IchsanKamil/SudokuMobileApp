import type * as React from '@react-navigation/core/lib/typescript/src/node_modules/@react-navigation/core/lib/typescript/src/node_modules/react';
import type { DefaultRouterOptions, NavigationState, NavigationAction, InitialState, PartialState, Route, ParamListBase } from '@react-navigation/core/lib/typescript/src/node_modules/@react-navigation/core/lib/typescript/src/node_modules/@react-navigation/routers';
...
export declare type RouteProp<ParamList extends ParamListBase, RouteName extends keyof ParamList> = Omit<Route<Extract<RouteName, string>>, 'params'> & (undefined extends ParamList[RouteName] ? Readonly<{
    /**
